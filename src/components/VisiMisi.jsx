    ...
    <section className="container-hmps py-24 md:py-28">
      <Reveal>
        ...
        <h2 className="font-display font-extrabold text-4xl md:text-5xl mt-5 mb-4 text-slate-900">
          Arah & <span className="text-blue-600">Tujuan</span> Kami
        </h2>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Reveal delay={0.1}>
          <div className="bg-gradient-to-br from-slate-900 to-blue-950 text-white rounded-3xl p-10 h-full flex flex-col justify-between min-h-[340px] relative overflow-hidden">
            ...
            <div className="flex items-center gap-2 text-slate-400 text-xs mt-10 pt-6 border-t border-white/10">
        ...
        <Reveal delay={0.2}>
          <div className="bg-white border border-slate-100 shadow-sm rounded-3xl p-10 h-full">
            <span className="inline-flex items-center gap-2 text-xs font-semibold tracking-wide text-blue-600 mb-6">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-600" /> MISI
            </span>
            <ol className="space-y-6">
              {misi.map((item, i) => (
                <li key={i} className="flex gap-4">
                  <span className="shrink-0 w-7 h-7 rounded-full bg-blue-600 text-white text-xs font-bold grid place-items-center">
